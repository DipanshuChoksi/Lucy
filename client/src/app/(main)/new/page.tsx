    ...
    <main className="flex-1 md:ml-64 w-full flex flex-col items-center justify-center px-gutter py-xl">
      <div className="w-full max-w-2xl text-center space-y-xl">
        ...
        <div className="relative w-full max-w-[36rem] mx-auto group">
          ...
          <input className="w-full pl-xl pr-xl py-md bg-surface-container-lowest border border-outline-variant rounded-full font-body-md text-body-md text-on-surface focus:outline-none focus:border-primary focus:ring-1 focus:ring-primary transition-all shadow-[0_10px_30px_rgba(0,0,0,0.04)] placeholder:text-outline" placeholder="Paste YouTube URL here..." type="url"/>
          <button className="absolute inset-y-0 right-0 pr-sm flex items-center text-primary hover:text-surface-tint transition-colors cursor-pointer">
